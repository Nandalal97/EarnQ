            ...
            <div className="content-row">
                <main className="app-container">
                    <div className="about-container">
                        ...
                        <h2 className="mt-3 text-md">Our Mission</h2>
                        <p>
                        ...
                        <h3 className="mt-3 text-md">What We Offer</h3>
                        ...
                        <h3 className="mt-3 text-md">What Makes Us Unique?</h3>
                        <ul className="text-xsm">
                        ...
                        <h3 className="mt-1 text-md">Who Can Join?</h3>
                        <ul className="text-xsm">
                        ...
                        <h3 className="mt-3 text-md">Our Commitment</h3>
                        <p>
                        ...
                        <h4 className="mt-3 text-md">Future Goals</h4>
                        <p>
                        ...
                        <p className="mt-3 text-xxsm text-muted">
                            <strong>Note:</strong> EarnQ is not a gambling or get-rich app. It is a rewards based on user knowledge, participation, and fair play. Coins are earned and used for features, contests, or eligible redemptions after verification.
                        </p>
                    </div>
                </main>
            </div>
