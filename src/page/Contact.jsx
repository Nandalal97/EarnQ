    ...
    <div className="page-wrapper">
      ...
      <div className="content-row">
        <main className="app-container">
          <h3 className="mb-2 text-md d-flex align-items-center gap-1">
          ...
          <div className="contact-container">
            ...
            <div className="pt-3">
              <form onSubmit={handleSubmit}>
                <div className="row g-3">
                  ...
                  <div className="col-12 text-center mt-4">
                    <button type="submit" className="btn-invite text-sm color-white bg-one border-0">
                      {trans.contactButton}
                    </button>
                  </div>
                </div>
              ...
              {successMsg && (
                <p className="alert alert-success text-xsm mt-2 py-2 text-center border-0">
                  {successMsg}
                </p>
              )}
              {error && (
                <p className="alert text-xsm alert-danger mt-2 py-2 text-center border-0">
                  {error}
                </p>
              )}
            </div>

            <div className="summary-box text-xsm alert alert-info border-0 mt-4">
