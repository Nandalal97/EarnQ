...
const MultiLangContestInstructions = ({ contest }) => {
            ...
            {lang === 'en' && (
                <div>
                    ...
                    <ul className="text-start text-xsm">
                        ...
                        <li><strong>Prize:</strong> Top 3 scorer wins <strong>₹{contest.prizeAmount}</strong>. In case of a tie, the participant who completes the exam earlier will be selected as the winner.</li>
                        ...
                        <li><strong>Result & Winner Announcement:</strong> Results will be declared within 72 hours. Winners will be notified via app, SMS, or email.</li>
            ...
            {lang === 'hi' && (
                <div>
                    ...
                    <ul className="text-start text-xsm">
                        ...
                        <li><strong>पुरस्कार:</strong> शीर्ष 3 स्कोरर जीतेंगे <strong>₹{contest.prizeAmount}</strong>. टाई होने पर, जो प्रतिभागी पहले परीक्षा पूरी करता है, वही विजेता होगा।</li>
                        ...
                        <li><strong>परिणाम और विजेता:</strong> 72 घंटे के भीतर परिणाम घोषित किया जाएगा। विजेताओं को ऐप, SMS या ईमेल के माध्यम से सूचित किया जाएगा।</li>
            ...
            {lang === 'bn' && (
                <div>
                    ...
                    <ul className="text-start text-xsm">
                        ...
                        <li><strong>পুরস্কার:</strong> শীর্ষ 3 স্কোরার প্রত্যেকে জিতবে <strong>₹{contest.prizeAmount}</strong>. টাই হলে, যে অংশগ্রহণকারী আগে পরীক্ষা শেষ করবে, সেই বিজয়ী হবে।</li>
                        <li><strong>বিজয়ী যোগ্যতা:</strong> পুরস্কার পেতে, আপনার স্কোর কমপক্ষে <strong>80%</strong> হতে হবে। কেউ যোগ্য না হলে কোন পুরস্কার বিতরণ হবে না।</li>
                        ...
                        <li><strong>জমা দেওয়ার নিয়ম:</strong>আপনি পরীক্ষাটি ম্যানুয়ালি সাবমিট করতে পারবেন, কিন্তু একবার সাবমিট করলে উত্তর পরিবর্তন বা রেসাবমিট সম্ভব নয়।
                        ...
                        <li><strong>ফলাফল এবং বিজয়ী:</strong> 72 ঘণ্টার মধ্যে ফলাফল ঘোষণা করা হবে। বিজয়ীদের অ্যাপ, SMS বা ইমেলের মাধ্যমে জানানো হবে।</li>
...
export default MultiLangContestInstructions;
